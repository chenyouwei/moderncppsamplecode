 ...
 *  Things to remember
 *
 *  # noexcept is part of a function's interface, and that means the callers may
 *    depend on it.
 *
 *  # noexcept functions are more optimizable than non-noexcept functions.
 *
 *  # noexcept is particularly valuable for the move opertations, swap, memory
