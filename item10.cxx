 ...
 *
 *  # Enumerations of scoped enums are visible only within the enum. They convert
...
int main() {
    ...
    auto uInfo = UserInfo("a", "b", 1);

    auto val = std::get<toUtType(UserInfoFileds::uiEmail)>(uInfo);
